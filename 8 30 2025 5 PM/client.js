...
let waitingSound; // Sound played when waiting for players
...
function setSoundVolumes() {
    ...
    setTimeout(() => {
        ...
        if (waitingSound && waitingSound.isLoaded()) {
...
function getPlayerIcon(imgElement, displayName, internalPlayerName) {
    ...
    // MOBILE FIX: Force emoji avatars on mobile browsers to avoid empty circles
