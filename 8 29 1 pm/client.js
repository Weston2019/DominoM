...
// Add global function to manually test waiting message
window.testWaitingMessage = function() {
    // console.log('🛠️ Manual waiting message test');
...
// Add global function to manually hide waiting message
window.hideWaitingMessage = function() {
    // console.log('🛠️ Manual hide waiting message');
...
function showWaitingForPlayersMessage() {
    ...
    // console.log('🔍 WAIT DEBUG - showWaitingForPlayersMessage called');
    // console.log('🔍 WAIT DEBUG - waitingDiv found:', !!waitingDiv);
    // console.log('🔍 WAIT DEBUG - messageText found:', !!messageText);
    ...
    if (waitingDiv && messageText) {
        ...
        // console.log('⏳ Showing waiting for players message');
        // console.log('🔍 WAIT DEBUG - Final waitingDiv styles:', {
        //   display: waitingDiv.style.display,
        //    visibility: waitingDiv.style.visibility,
        //   opacity: waitingDiv.style.opacity,
        //   zIndex: waitingDiv.style.zIndex
        //   });
    } else {
...
function updatePlayerCountDisplay(playerCount) {
    ...
    if (playerCountText && messageText) {
        ...
        // console.log('🔍 COUNT DEBUG - Final text content:', {
        //    playerCountText: playerCountText.textContent,
...
function startGameSession() {
  ...
  // Continue with game setup...
    ...
    socket.on('playerCount', (data) => {
        ...
        // console.log('🔍 WAIT DEBUG - Elements found:', {
    ...
    socket.on('gameState', (state) => {
        ...
        if (shouldShowDialog) {
            ...
            // Play win sound for any hand win (including blocked games)
            if (winSound && winSound.isLoaded()) {
                try {
                    winSound.play();
                } catch (error) {
...
function updatePlayersUI() {
    ...
    Object.entries(playerPositions).forEach(([playerName, position]) => {
        ...
        let youText = (playerName === myJugadorName ? `(${window.lang.t})` : '');
